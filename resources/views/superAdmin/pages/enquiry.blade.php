...
@section('data_layout')
{{-- <button type="button"  class="btn btn-primary car-modal-open" data-toggle="modal" data-target="#exampleModalCenter">
    Launch demo modal
  </button> --}}
                    ...
                    <div class="carInfo-modal-input-div">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 carInfo-input-col">
                                ...
                                <div class="input-div">
                                    <input type="text"  class="form-control common-car-input carCombineTransmission"
                                    />
                                </div>
...
@include('superAdmin.components.enquiryList')
        ...
        $.ajax({
            ...
            success: data => {
                ...
                if(data.data.Response.StatusCode=="Success"){
                    ...
                    $('.carEngineSize').val(data.data.Response.DataItems.VehicleRegistration.EngineCapacity);
                    $('.carBody').val(data.data.Response.DataItems.SmmtDetails.BodyStyle);
                    $('.carEngineNumber').val(data.data.Response.DataItems.VehicleRegistration.EngineNumber);
                    $('.carEngineCode').val(data.data.Response.DataItems.TechnicalDetails.General.Engine.Code.CodeList[0].EngineCode);
                    ...
                    $('.carSeatCapacity').val(data.data.Response.DataItems.VehicleRegistration.SeatingCapacity);
                    $('.carWheelPlan').val(data.data.Response.DataItems.VehicleRegistration.WheelPlan);
                    $('.carAspiration').val(data.data.Response.DataItems.TechnicalDetails.General.Engine.Aspiration);
                    $('.carMaximumBHP').val(data.data.Response.DataItems.TechnicalDetails.Performance.Power.Bhp);
                    ...
                    $('.carCylinders').val(data.data.Response.DataItems.TechnicalDetails.General.Engine.NumberOfCylinders);
                    $('.carValves').val(data.data.Response.DataItems.TechnicalDetails.General.Engine.NumberOfCylinders * data.data.Response.DataItems.TechnicalDetails.General.Engine.ValvesPerCylinder);
