...
class SuperAdminController extends Controller
{
    ...
    {  
        ...
        // Get the number of days from the request (you can adjust this based on your input)
        $daysToAdd = $day;
        ...
        // Set the final date to the end of the day (23:59:59)
        $finalDate->endOfDay();

        // Format the final date to the desired format (e.g., "Y-m-d H:i:s")
        $formattedFinalDate = $finalDate->format('Y-m-d H:i:s');
        $business_profile->subscribed_at = Carbon::now()->format('Y-m-d H:i:s');
        $business_profile->expiry_date = $formattedFinalDate;
        $business_profile->subscribed_till = $formattedFinalDate;
