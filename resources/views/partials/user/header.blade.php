            ...
            <div class="modal-body">
                ...
                <div class="modal-content-div">
                    <div class="modal-content-top-div">
                        <div class="ref-div">
                            <span>Ref # : 9429422</span>
                        </div>
                        <div class="modal-title-div">
                            <span>Enter your quotation</span>
                        </div>
                        <div class="modal-top-right-div">
                            <span class="name-badge">FSE34D</span>
                        </div>
                    </div>
                    <div class="modal-content-main-div">
                        <div class="modal_content_info-div">
                            <div class="name">
                                ...
                                <input type="text" class="form-control info-input" placeholder="Enter your name here"
                                    id="full_name" name="full_name" />
                            </div>
                            <div class="phone">
                                <label for="">Phone Number</label> <br />
                                <input type="text" class="form-control info-input"
                                    placeholder="Enter your number here" id="number" name="number" />
                            </div>
                            <div class="email">
                            ...
                            <div class="address">
                                ...
                                <input type="text" class="form-control info-input" placeholder="Enter address here"
                        ...
                        <div class="type-charge-div">
                            ...
                            <div class="type-charge-main-content">
                                <div class="single-type-charge">
                                    ...
                                    <div class="charge">
                                        <input type="text" class="form-control charge-input" value="10" />
                                    </div>
                                </div>
                                <div class="single-type-charge">
                                    <div class="type">
                                ...
                                <div class="single-type-charge">
                                    <div class="type">
                                        <span>VAT</span> &nbsp; <input type="checkbox" />
                                        <span class="tbc-text">TBC</span>
                                    </div>
                                    <div class="charge">
                                        <input type="text" class="form-control charge-input" value="10" />
                            ...
                            <div class="total-amount-select-div">
                                <div class="Warranty-div common-amount-type-div">
                                    ...
                                    <div class="total-amount-select">
                                        <select class="form-select type-select-total-amount"
                                ...
                                <div class="condition-div common-amount-type-div">
                                    ...
                                    <div class="condition-select">
                                        <select class="form-select type-select-total-amount"
                                            aria-label="Default select example">
                                            <option selected>Reconditioned</option>
                                ...
                                <div class="mileage-div common-amount-type-div">
                                    ...
                                    <div class="mileage-select">
                                        <select class="form-select type-select-total-amount"
                                            aria-label="Default select example">
                                            <option selected>40 km</option>
                                            <option value="1">40 km</option>
                                            <option value="2">40 km</option>
                                            <option value="3">40 km</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="total-number">
                                    <span>Total Amount:</span> <span>10</span>
                                </div>
                            </div>
                        ...
                        <div class="selling-point-div">
                            ...
                            <div class="selling-point-title-div">
                                <input class="form-control" type="text" name="selling_point_title"
                                    id="selling_point_title" placeholder="Enter Selling point title" />
                            </div>
                        </div>
                        <div class="quotes-notes-div">
                            ...
                            <div class="quotes-notes-input-div">
                                <textarea class="form-control" id="quotes_notes" name="quotes_notes" rows="4" placeholder="type notes here"></textarea>
                            </div>
                        </div>
                        <div class="terms-condition-div">
                            ...
                            <div class="terms-condition-input-div">
                                ...
                                <textarea class="form-control" id="terms_condition" rows="4" placeholder="type terms & Conditions here"></textarea>
                            </div>
                        </div>
                        <div class="quotes-send-button-div">
                            <div class="send-email common-btn-style">
                                <span>Send Email</span>
                            </div>
                            <div class="send-sms common-btn-style">
                                <span>Send SMS</span>
                            </div>
                            <div class="send-quotes common-btn-style">
