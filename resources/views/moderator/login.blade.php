            ...
            <div class="login-main-content">
                ...
                <div class="login-right-div">
                    ...
                    <div class="login-input-div">
                        <form action="{{ route('moderator.check') }}" method="POST">
                            @csrf
                            <div class="email-div">
                            ...
                            <div class="remember-forgot-div">
                                <div class="remember-me-input-div">
                                    <input style="cursor: pointer" type="checkbox" name="remember_me"
                                        id="">&nbsp;<span class="remember-me-text"> Remember for 30 days</span>
                                </div>
                                <div>
                                    <a href="{{ route('moderator.forgot.form') }}"
                                        style="color: inherit;text-decoration:none"> <span style="cursor: pointer"
