...
<head>
    ...
    <title>V6AUTOCENTRE Login</title>
</head>
            ...
            <div class="login-main-content">
                ...
                <div class="login-right-div">
                    ...
                    <div class="login-input-div">
                        <form action="{{ route('moderator.forgot.link') }}" method="POST">
                            @csrf
                            <div class="email-div">
                   ...
                   <span>Not a member?</span><span><a style="text-decoration: none; color:inherit" href="{{route('moder.register')}}">Create account</a> </span>
                </div> --}}
                    </div>
                </div>
            </div>
